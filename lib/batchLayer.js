...
internals.detectReports = function(next) {
...
module.exports.init = function (options, next) {
    ...
    console.log('optiooonos', options)

    if (options.scrubAtStart == true) {
        tasks['scrubMaster'] = internals.scrubData
    }
...
exports.scrubData = internals.scrubData = function(next) {
