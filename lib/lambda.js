...
internals.Lambda.prototype.getReport = function(query, callback) {
    // TO DO: Validate query
    Async.parallel({
        batchGetReports: Async.apply(Batch.getBatches, query),
        // speedRunAgg: Async.apply(Speed.runAgg, query)
    }, function(err, results){
        // var report = Serving.combine(results.batchGetReports);
        // TO DO ADD ERROR HANDLING
        callback(null, results.batchGetReports);
